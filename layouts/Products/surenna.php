        ...
        <section class="p-t-50 p-b-50">
            <div class="container">
                <div class="row p-t-50 p-b-50">
                    ...
                    <div class="col-lg-4 offset-lg-1 d-flex flex-column justify-content-center order-last">
                        <table class="table m-b-0" style="font-size: 14px;">
                            <tbody>
                                <tr>
                                    <td><p class="text-muted m-b-0">{$lang.location}: Manzana 857, Región 11, Tulum, Q.R.</p></td>
                                </tr>
                                <tr>
                                    <td><p class="text-muted m-b-0">{$lang.type}: {$lang.houses} & {$lang.lots}</p></td>
                                </tr>
                                <tr>
                                    <td><p class="text-muted m-b-0">{$lang.status}: 30% {$lang.sold}</p></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
                ...
                <!-- <div class="p-t-50 p-b-50">
                    <p class="text-muted font-weight-semibold text-center">{$lang.our_proyects_surenna_description}</p>
                </div> -->
                <div class="p-b-50 visit_website">
                    <a href="https://www.surenna.mx/es" target="_blank">{$lang.visit_website}</a>
                </div>
            </div>
        </section>
    </main>
