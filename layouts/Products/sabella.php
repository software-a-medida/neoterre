        ...
        <section class="p-t-50 p-b-50">
            <div class="container">
                <div class="row p-t-50 p-b-50">
                    ...
                    <div class="col-lg-4 offset-lg-1 d-flex flex-column justify-content-center order-last">
                        <table class="table m-b-0" style="font-size: 14px;">
                            <tbody>
                                <tr>
                                    <td><p class="text-muted m-b-0">{$lang.location}: Lote 002-20, Manzana 923, Región 12, Tulum, Q.R.</p></td>
                                </tr>
                                <tr>
                                    <td><p class="text-muted m-b-0">{$lang.type}: {$lang.houses}</p></td>
                                </tr>
                                <tr>
                                    <td><p class="text-muted m-b-0">{$lang.status}: 0% {$lang.sold}</p></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
                ...
                <!-- <div class="p-t-50 p-b-50">
                    <p class="text-muted font-weight-semibold text-center">{$lang.our_proyects_sabella_description}</p>
                </div> -->
                <div class="p-b-50 visit_website">
                    <a href="https://www.sabella.mx/" target="_blank">{$lang.visit_website}</a>
                </div>
            </div>
        </section>
    </main>
