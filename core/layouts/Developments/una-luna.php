    ...
    <main id="main-content">
        <section class="p-tb-50">
            <div class="container">
                ...
                <h1 class="text-uppercase m-t-30 font-weight-bold">Una Luna</h1>

                <div class="row no-gutters">
                    <div class="col-12">
                        <div class="page-cover d-flex flex-column justify-content-center">
                            <figure class="m-0">
                                <img src="{$path.uploads}Enmascarar grupo 42.png" alt="" class="img-cover">
                            </figure>

                            <div class="col-12 col-md-6">
                                <h1 class="text-uppercase text-light m-b-40">Lofts de ensueño con el sello Tulum</h1>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-12 col-md-6 d-flex flex-column justify-content-center">
                        <h2 class="text-uppercase m-b-30">Comodidad, practicidad y rentabilidad asegurada.</h2>
                        <p class="">Un proyecto ideal para aquellos que buscan rentabilidad en su inversión, por su excelente ubicación en Tulum que le garantiza una alta ocupación durante todo el año, teniendo en cuena la gran demanda de viajeros de todo el mundo.</p>
                    </div>
                    <div class="col-12 col-md-6">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-12 col-md-8">
                        <figure class="img-fluid m-0">
                            <img src="{$path.uploads}una-luna-map.png" alt="" class="img-cover">
                        </figure>
                    </div>
