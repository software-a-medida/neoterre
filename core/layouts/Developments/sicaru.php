                    ...
                    <div class="col-12">
                        <div class="page-cover d-flex flex-column justify-content-center">
                            ...
                            <div class="col-12 col-md-6">
                                <h1 class="text-uppercase text-light m-b-40">Un lote con infinitas posibilidades</h1>

                                <a href="{$path.uploads}Sicaru_Brochure_español.pdf" download="Sicaru_Brochure_español.pdf" class="btn btn-light text-uppercase font-weight-bold">Descargar brochure</a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-6 d-flex align-items-center justify-content-center">
                        ...
                        <h5 class="d-flex m-0 m-l-10" style="font-size: 2.5rem;"><span class="d-flex flex-column justify-content-center m-l-10" style="font-size: 1.3rem;">A partir de <br>260 USD por m2.</span></h5>
                    </div>
                    <div class="col-md-6 d-flex align-items-center justify-content-center">
                        <figure class="thumb-md d-flex align-items-center flex-column justify-content-center m-0">
                            <img src="{$path.images}icon-plano.png" alt="" class="img-fluid">
                        </figure>
                        <h5 class="d-flex m-0 m-l-10" style="font-size: 2.5rem;">1 <span class="d-flex flex-column justify-content-center m-l-10" style="font-size: 1.3rem;">Lote disponible</h5>
                    </div>
                </div>
            </div>
        </section>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-12 col-md-6 d-flex flex-column justify-content-center">
                        <h2 class="text-uppercase m-b-30">El sueño de vivir en tulum, más cerca que nunca</h2>
                        <p class="">El proyecto cuenta con una excelente ubicación a 50 metros de la carretera principal de Tulum y goza de categorización de suelo H3. ideal para construir múltiples tipos de viviendas. Los lotes están urbanizados, con acceso pavimentado, servicios de electricidad ocultos y una zona peatonal. A su vezx, cuenta con agua potable y está listo para escriturar y construir.</p>
                    </div>
                    <div class="col-12 col-md-6">
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-12 col-md-4 m-t-30 offset-md-4 suffix-md-4">
                        <a href="{$path.uploads}Sicaru_Brochure_español.pdf" download="Sicaru_Brochure_español.pdf" class="btn btn-dark btn-block text-uppercase">Descargar brochure</a>
                    </div>
                </div>
            </div>
        </section>
