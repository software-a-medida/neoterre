                    ...
                    <div class="col-12">
                        <div class="page-cover d-flex flex-column justify-content-center">
                            ...
                            <div class="col-12 col-md-6">
                                <h1 class="text-uppercase text-light m-b-40">Una comunidad unifamiliar de lujo en Tulum</h1>

                                <a href="{$path.uploads}Surenna_Brochure_español.pdf" download="Surenna_Brochure_español.pdf" class="btn btn-light text-uppercase font-weight-bold">Descargar brochure</a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-4 d-flex align-items-center justify-content-center">
                        ...
                        <h5 class="d-flex m-0 m-l-10" style="font-size: 2.5rem;">3 <span class="d-flex flex-column justify-content-center m-l-10" style="font-size: 1.3rem;">Modelos de <br>casas.</span></h5>
                    </div>
                    <div class="col-md-4 d-flex align-items-center justify-content-center">
                        <figure class="thumb-md d-flex align-items-center flex-column justify-content-center m-0">
                            <img src="{$path.images}icon-casas.png" alt="" class="img-fluid">
                        </figure>
                        <h5 class="d-flex m-0 m-l-10" style="font-size: 2.5rem;">25 <span class="d-flex flex-column justify-content-center m-l-10" style="font-size: 1.3rem;">Casas de 3 y 4 <br>recámaras.</span></h5>
                    </div>
                    <div class="col-md-4 d-flex align-items-center justify-content-center">
                        <figure class="thumb-md d-flex align-items-center flex-column justify-content-center m-0">
                            <img src="{$path.images}icon-plano.png" alt="" class="img-fluid">
                        </figure>
                        <h5 class="d-flex m-0 m-l-10" style="font-size: 2.5rem;">34 <span class="d-flex flex-column justify-content-center m-l-10" style="font-size: 1.3rem;">Lotes desde <br>$975,000 MXN</span></h5>
                    </div>
                </div>
            </div>
        </section>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-12 col-md-6 d-flex flex-column justify-content-center">
                        <h2 class="text-uppercase m-b-30">Viviendas pensadas para disfrutar del paraíso.</h2>
                        <p class="">Sus 59 propiedades están divididas entre 25 residencias unifamiliares de lujo (de 3 y 4 recámaras, estacionamiento privado con posibilidad de agregar alberca y terraza) y 34 lotes.</p>
                    </div>
                    <div class="col-12 col-md-6">
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-12 col-md-4 m-t-30 offset-md-4 suffix-md-4">
                        <a href="{$path.uploads}Surenna_Brochure_español.pdf" download="Surenna_Brochure_español.pdf" class="btn btn-dark btn-block text-uppercase">Descargar brochure</a>
                    </div>
                </div>
            </div>
        </section>
