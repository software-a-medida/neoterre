            ...
            <div class="container">
                <div class="row no-gutters p-b-50">
                    ...
                    <div class="col-1 text-right">
                        <a href="javascript:void(0);" class="btn btn-link p-lr-5" style="font-size: 2rem;"> <i class="fa fa-facebook"></i> </a>
                        <a href="javascript:void(0);" class="btn btn-link p-lr-5" style="font-size: 2rem;"> <i class="fa fa-instagram"></i> </a>
                    </div>
                </div>
