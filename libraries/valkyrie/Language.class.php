...
class Language
{
    ...
    */
    public function check_lang()
    {
        ...
        if ( !isset($_COOKIE['lang']) || is_null($_COOKIE['lang']) || $_COOKIE['lang'] == false )
        {
    ...
    */
    public static function get_lang( $buffer, $section = false, $path = false )
    {
        ...
        if ( $path != false ) $ini = (new self)->format->import_file($path, $_COOKIE['lang'], 'ini');
        else $ini = (new self)->format->import_file(self::$path_language, $_COOKIE['lang'], 'ini');
